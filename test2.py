...
if __name__ == "__main__": 
    ...
    master.bind("<KeyPress-a>", lambda e: gfg.left(e)) 
    master.bind("<KeyPress-d>", lambda e: gfg.right(e)) 
    master.bind("<KeyPress-w>", lambda e: gfg.up(e)) 
    master.bind("<KeyPress-s>", lambda e: gfg.down(e)) 
